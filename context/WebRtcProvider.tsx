    ...
    const getMediaStream = async () => {
        try {
            ...
            try {
                ...
                console.log(
                    `[WebRTC] Audio tracks: ${stream.getAudioTracks().length}, Video tracks: ${stream.getVideoTracks().length}`
                );
        ...
        const interval = setInterval(() => {
            if (remoteStreamRef.current) {
                ...
                audioTracks.forEach((track) => {
                    ...
                    console.log(
                        `[WebRTC] Kiểm tra audio track: ${track.id}, Enabled: ${track.enabled}, ReadyState: ${track.readyState}`
                    );
