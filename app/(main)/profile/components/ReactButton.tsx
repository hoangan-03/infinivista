...
interface ReactButtonProps {
    reactionList: {id: number; type: ReactionType; count: number; people: Array<{id: number}>}[];
...
const ReactButton: React.FC<ReactButtonProps> = ({reactionList, handleClickReact, className}) => {
    const liked = reactionList.some((reaction) => reaction.people.some((person) => person.id === CurrentUser.id));
