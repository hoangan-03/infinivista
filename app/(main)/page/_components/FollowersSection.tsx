...
import {useGetInfinitePageFollowers} from '@/modules/page/page.swr';
...
export const FollowersSection: React.FC<FollowersSectionProps> = ({page, className}) => {
    const router = useRouter();

    const {data: followers, pagination, size, setSize, isValidating, isLoading} = useGetInfinitePageFollowers(page?.id);
