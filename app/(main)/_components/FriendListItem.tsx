...
export const FriendListItem: React.FC<FriendListItemProps> = ({data, onViewProfile, className}) => {
    return (
        <div
            className={cn(
        ...
        >
            <div className='flex min-w-0 items-center gap-3'>
                ...
                <div className='flex min-w-0 flex-col gap-1'>
                    <p className='truncate text-subtitle2 font-bold text-gray-700'>{data.username}</p>
                    {/* {data.isMutualFriend && (
