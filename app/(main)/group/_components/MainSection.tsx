...
import {useGetInfiniteGroupPosts} from '@/modules/group/group.swr';
...
export const MainSection: React.FC<MainSectionProps> = ({group, className}) => {
    const {data: posts, pagination, size, setSize, isValidating, isLoading} = useGetInfiniteGroupPosts(group?.id);
